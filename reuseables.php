...
$reuseables = array(
    ...
    "XMAIL" => array(
        'TOP' => '<!DOCTYPE html><html lang="en" style="padding: 0; margin: 0;">
                ...
                <div style="padding: 10px; background: #37066b; min-height: 60px;">
                    ...
                    </div></div><div style="position: relative; padding: 25px;">',
        'BOTTOM' => '</div><br><br>
                <footer style="background-color: white; color: #c7c7c7; text-align: center; font-size: 11px;">
                <div style="background-color: #37066b; color: white; padding: 20px 0px;"><p>Great to have you on board</p>
                </div><center style="padding: 10px;"><p>Dalton House, 60 Windsor Ave, London, UK SW19 2RR</p><span style="margin: 3px 7px;">Mail: support@wievatrade.com</span><br>
                <span style="margin: 3px 7px;">Phone: (+44) 791-921-4075</span></center></footer></div></body></html>'
    )
);
