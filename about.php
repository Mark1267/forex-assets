  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 text-center wow fadeInDown">
        ...
        <p class="bottom20" >Forex-Assetshas been helping marketing teams optimize delivery of awesome customer experiences for <br>decades. With a team of trailblazers and innovators at the helm, Forex-Assetsis <br>trusted by some of the world’s top companies across the globe.</p><br>
      </div>
    </div>
    <div class="row">
            ...
            <div class="right">
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p class="bottom15">Over $55B and counting - More than 175,000 people trust over $55 billion with Forex-AssetsAssets companies.</p>
                </div>
              </div>
              <div class="media">
                <div class="media-left">
              ...
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p>Powerful backing - Forex-AssetsAssets is backed by $1B in investment from some of the world's largest financial institutions.</p>
                </div>
              </div>
            </div>
      </div>
