...
<section class="page_header" style="background-position: 50% -80px; background: url(<?php echo BASE_URL . '/assets/open/images/mi1.jpg'?>) no-repeat !important; padding: 110px 0;">
  <div class="container">
    <div class="row">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="quality_wrap clearfix">
        <div class="col-md-6">
          <div class="left"> <img src="<?php echo BASE_URL . '/assets/open/images/h2.jpg'?>" alt="quality"> </div>
        </div>
        <div class="col-md-6">
            <div class="right">
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p class="bottom15">Over $55B and counting - More than 175,000 people trust over $55 billion with WievaTradeAssets companies.</p>
                </div>
              </div>
              <div class="media">
                <div class="media-left">
              ...
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p>Powerful backing - WievaTradeAssets is backed by $1B in investment from some of the world's largest financial institutions.</p>
                </div>
              </div>
            </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="accordion-container bottom40">
          ...
          <div class="do_media media bottom40">
              <div class="media-left"> <a href="#"> <img class="media-object" src="<?php echo BASE_URL . '/assets/open/images/a3.jpg'?>" alt="What We Do"> </a> </div>
            <div class="media-body">
