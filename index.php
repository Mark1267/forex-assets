  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 text-center wow fadeInDown">
        ...
        <p class="heading_space">How to Start Investing with ForexAssets</p>
      </div>
    </div>
    <div class="row info">
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 text-center wow fadeInDown">
        ...
        <p class="bottom20" >ForexAssets has been helping marketing teams optimize delivery of awesome customer experiences for <br>decades. With a team of trailblazers and innovators at the helm, ForexAssets is <br>trusted by some of the world’s top companies across the globe.</p><br>
      </div>
    </div>
    <div class="row">
