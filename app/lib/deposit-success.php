...
<body style="background: #eee; font-size: 12px; text-align: center;">
    <div style="background-color: white; min-width: 200px; max-width: 600px; margin: auto; padding: 10px; border-radius: 7px;">
        ...
        <div style="background-color: #eee; padding: 5px; color: black; font-family: Verdana, Geneva, Tahoma, sans-serif;">
            ...
            <br>
            <h2>{TITLE}</h2>
            <p>Your request for a deposit of <code style="background-color: #fff; border-radius: 4px; padding: 5px;">${AMOUNT}</code> to <code style="background-color: #fff; border-radius: 4px; padding: 5px;">{ADDRESS}</code> was successful.</p>
            <p>Thank you for choosing us. Once you have logged in your plan will be activated. Log back into your <a href="https://zilextrade.com/auth-signin.php">dashboard.</a></p>
