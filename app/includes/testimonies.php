...
<section id="people" class="padding">
  <div class="container">
    ...
    <style>.iklk{border-radius: 50%;}</style>
    <div id="people_slider" class="owl-carousel">
      ...
      <div class="item">
        ...
        <div class="testinomial_pic text-right pull-right">
          ...
          <div class="pic"><img width="58px" class="iklk" alt="testinomial" src="<?php echo BASE_URL . '/assets/open/images/1.jpg'; ?>"></div>
        </div>
      </div>
      <div class="item">
        <div class="people_wrap border_radius left">
        ...
        <div class="testinomial_pic">
          ...
          <div class="testinomial_body">
            <span class="name">Bard Markson</span>
            <span class="post_img">Client</span>
          </div>
        </div>
      </div>
      <div class="item">
        ...
        <div class="testinomial_pic text-right pull-right">
          <div class="testinomial_body">
            <span class="name">Sarah E. Davison</span>
            <span class="post_img">Client</span>
          </div>
          <div class="pic"><img width="58px" class="iklk" alt="testinomial" src="<?php echo BASE_URL . '/assets/open/images/6.jpg'; ?>"></div>
        </div>
      </div>
    </div>
  </div>
