    ...
    <div class="container" style="background-color:white; max-width: 1000px; margin: 0px auto; position: relative;">
        ...
        <div class="row" style="position: relative; padding: 4px;">
            ...
            <div class="col-12" style="padding: 4px; word-wrap: break-word;">
                ...
                <a href="https://forex-assets.exchange/signin" class="btn" style="margin: 15px auto; display: inline-block; text-align: center; padding: 9px 20px; border-radius: 4px; color: white; background-color: #ffcc29; text-decoration: none;">Dashboard</a></div> 
