...
<body style="padding: 0; margin: 0; background: rgb(248, 248, 248); font-family: Arial; font-size: 15px;">
    <div class="container" style="background-color:white; max-width: 1000px; margin: 0px auto; position: relative;">
        <div style=" padding: 10px; background: #373435; color: #ffff;">
            <div style="margin: 0px auto; width: 33.33%;">
                <img src="#logo#" alt="forex_assets_logo" style="width: 100%; vertical-align: middle;">
            </div>
        </div>
        <div style="position: relative; padding: 4px;">
            ...
            <div style="padding: 4px; word-wrap: break-word;">
                <p style="line-height: 30px;">
                    You have requested for a withdrawal of 
                    <code style="background-color: #fff; border-radius: 4px; padding: 5px;">
                        $#amount#
                    </code>
                     to 
                    <code style="background-color: #fff; border-radius: 4px; padding: 5px;">
                ...
                <tr style="padding: 10px; background-color:  #c7c1c3;">
                    <th style="padding: 10px; background-color: #8e8b8c; width: 40%;">Transaction Type</th>
                    <td style="padding: 10px;">Withdrawal Request</td>
                </tr>
                <tr style="padding: 10px; background-color:  #c7c1c3;">
                    <th style="padding: 10px; background-color: #373435; color: #ffff; width: 40%;">Transaction Amount</th>
                    <td style="padding: 10px;">$#amount#</td>
                </tr>
                <tr style="padding: 10px; background-color:  #c7c1c3;">
                    <th style="padding: 10px; background-color: #8e8b8c; width: 40%;">Transaction Currency</th>
                    <td style="padding: 10px;">#currency#</td>
                </tr>
                <tr style="padding: 10px; background-color:  #c7c1c3;">
                    <th style="padding: 10px; background-color: #373435; color: #ffff; width: 40%;">Wallet ID</th>
    ...
    <footer style="background-color: #343537; color: #c7c7c7; text-align: center; font-size: 10px;">
        <div style="background-color: #ffcc29; color: #343537; padding: 20px 0px;">
            <p>Great to have you on board</p>
        </div>
            <center style="padding: 10px;"><p>18, 6 Wester Hailes Park, Edinburgh EH14 3AF,<br> United Kingdom</p>
