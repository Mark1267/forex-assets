...
<!-- Page Title -->
<section class="page_header" style="background: url(<?php echo BASE_URL . '/assets/open/images/news.jpg'?>) !important; background-attachment: fixed !important; background-size: cover !important;">
  <div class="container">
    <div class="row">
